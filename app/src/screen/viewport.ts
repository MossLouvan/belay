...
export function useViewport(options: ViewportOptions): Viewport {
  const { sizeRef, mode, button, onButtonUsed, onError, reducedMotion, inputBlocked, screen, onPointer, activeMods, onSwipe, isMac, onPadInput } =
    options;
  ...
  }, [mode, button, inputBlocked, reducedMotion, onError, onButtonUsed, screen, onPointer, activeMods, onSwipe, isMac, onPadInput]);
