...
$src = @('BelayHost.cs', 'BelayHostDisplays.cs', 'BelayHostWindows.cs', 'BelayHostVirtualDisplay.cs', 'BelayHostAudio.cs', 'BelayHostClipboard.cs', 'BelayHostNotify.cs') | ForEach-Object { Join-Path $here $_ }
