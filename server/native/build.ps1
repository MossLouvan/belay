...
$src = @('BelayHost.cs', 'BelayHostDisplays.cs', 'BelayHostWindows.cs', 'BelayHostVirtualDisplay.cs', 'BelayHostAudio.cs', 'BelayHostClipboard.cs') | ForEach-Object { Join-Path $here $_ }
