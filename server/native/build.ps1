...
$src = @('BelayHost.cs', 'BelayHostGamepad.cs', 'BelayHostDisplays.cs', 'BelayHostWindows.cs', 'BelayHostVirtualDisplay.cs', 'BelayHostAudio.cs', 'BelayHostClipboard.cs', 'BelayHostNotify.cs', 'BelayHostTray.cs') | ForEach-Object { Join-Path $here $_ }
