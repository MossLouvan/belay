...
if (testCodeActive()) {
  console.warn(
    '[pairing] BELAY_TEST_CODE is set: the pairing code is fixed and reusable, ' +
...
// that Belay hasn't already wrapped. Previews only — never full transcripts.
...
server.on('error', (e: NodeJS.ErrnoException) => {
  ...
  Most likely the Belay agent is already running — in which case your computer
