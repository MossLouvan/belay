...
- [x] iOS bundle id set (`com.mosslouvan.belay` — moved after the rename
      once re-pairing was accepted; to iOS it is a new app, so the old Tether
      build and its saved computers were deliberately left behind)
